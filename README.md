...
`sudo wget -qO /root/nm-quick-interactive.sh https://raw.githubusercontent.com/netspeedy/netmaker/master/scripts/nm-quick-interactive.sh && sudo chmod +x /root/nm-quick-interactive.sh && sudo /root/nm-quick-interactive.sh`  
